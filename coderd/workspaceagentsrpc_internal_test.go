...
func TestAgentWebsocketMinder_ContextCancel(t *testing.T) {
	t.Parallel()
...
func TestAgentWebsocketMinder_PingTimeout(t *testing.T) {
	t.Parallel()
	ctx := testutil.Context(t, testutil.WaitShort)
	now := dbtime.Now()
	fConn := &fakePingerCloser{}
...
func TestAgentWebsocketMinder_BuildOutdated(t *testing.T) {
	t.Parallel()
	ctx := testutil.Context(t, testutil.WaitShort)
	now := dbtime.Now()
	fConn := &fakePingerCloser{}
...
func TestAgentWebsocketMinder_SendPings(t *testing.T) {
	t.Parallel()
	ctx := testutil.Context(t, testutil.WaitShort)
	fConn := &fakePingerCloser{}
	uut := &agentWebsocketMinder{
